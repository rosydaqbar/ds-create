...
This section defines the visual and structural grammar for generated Frames, component regions, and their arrangement on Figma Page canvases.
...
This file owns only **global** rules:
- Figma terminology;
- documentation layout/composition;
- visual teaching patterns;
- variable-table behavior;
- global Base Component canvas behavior;
- token architecture;
- collection naming;
- token naming.

Page-specific anatomy, matrices, Notes & Documentation, examples, and QA remain in the Markdown specification under `guidance/`, `foundations/`, or `base-components/`.

Do not duplicate page-specific rules here.
